Shader "Hidden/Locked/.poiyomi/Old Versions/8.0/Poiyomi Outline/20cdb72e015f6e743b43e5fffd2b81c2"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			float4 frag(v2f i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				float3 mainNormal = UnpackScaleNormal(POI2D_SAMPLER_PAN(_BumpMap, _MainTex, poiUV(poiMesh.uv[(0.0 /*_BumpMapUV*/)], float4(1,1,0,0)), float4(0,0,0,0)), _BumpScale);
