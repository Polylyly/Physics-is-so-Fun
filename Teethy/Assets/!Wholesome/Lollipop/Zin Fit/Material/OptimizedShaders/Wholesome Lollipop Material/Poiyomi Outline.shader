Shader "Hidden/Locked/.poiyomi/Old Versions/8.0/Poiyomi Outline/287e7555c69f534469a8f4620560ec5c"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			float2 distortedUV(in PoiMesh poiMesh)
			{
				...
				#endif
				#if defined(PROP_DISTORTIONMASK) || !defined(OPTIMIZER_ENABLED)
				half distortionMask = POI2D_SAMPLER_PAN(_DistortionMask, _MainTex, poiMesh.uv[(0.0 /*_DistortionMaskUV*/)], float4(0,0,0,0)).r;
				#else
			...
			void applyDecals(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiCam poiCam, in PoiMods poiMods, in PoiLight poiLight)
			{
				...
				uv = decalUV((1.0 /*_DecalTextureUV*/), float4(1,1,0,0), float4(0.5,0.5,0,0), (0.0 /*_DecalRotation*/) + decalRotation, (0.0 /*_DecalRotationSpeed*/), decalScale, float4(0,0,0,0) +sideMod, (0.0 /*_Decal0Depth*/), poiMesh, poiCam);
				ddxuv = ddx(uv);
				ddyuv = ddy(uv);
				if (any(fwidth(uv) > .5))
				{
				...
				decalColor = tex2D(_DecalTexture, uv + float4(0,0,0,0) * _Time.x, ddxuv, ddyuv) * float4(poiThemeColor(poiMods, _DecalColor.rgb, (0.0 /*_DecalColorThemeIndex*/)), _DecalColor.a);
				#else
				uv = decalUV((1.0 /*_DecalTextureUV*/), float4(1,1,0,0), float4(0.5,0.5,0,0), (0.0 /*_DecalRotation*/) + decalRotation, (0.0 /*_DecalRotationSpeed*/), decalScale, float4(0,0,0,0) +sideMod, (0.0 /*_Decal0Depth*/), poiMesh, poiCam);
				decalColor = float4(poiThemeColor(poiMods, _DecalColor.rgb, (0.0 /*_DecalColorThemeIndex*/)), _DecalColor.a);
				#endif
				...
				#endif
				poiFragData.baseColor.rgb = lerp(poiFragData.baseColor.rgb, customBlend(poiFragData.baseColor.rgb, decalColor.rgb, (0.0 /*_DecalBlendType*/)), decalColor.a * saturate(_DecalBlendAlpha + audioLinkDecalAlpha0));
			...
			void calculateShading(inout PoiLight poiLight, inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiCam poiCam)
			{
				...
				float shadowStrength = (0.39 /*_ShadowStrength*/) * poiLight.shadowMask;
				#ifdef POI_PASS_OUTLINE
				...
				poiLight.finalLighting = min(lerp(poiLight.indirectColor * float4(1,1,1,1), float4(1,1,1,1), (0.6 /*_LightingIgnoreAmbientColor*/)) + (sss * poiLight.directColor), poiLight.directColor);
				#endif
				#endif
				#ifdef POI_PASS_ADD
				...
				if ((1.0 /*_LightingAdditiveType*/) == 1)
				{
					...
					#endif
					if ((0.7 /*_LightingAdditiveGradientEnd*/) == (0.0 /*_LightingAdditiveGradientStart*/)) (0.7 /*_LightingAdditiveGradientEnd*/) += 0.001;
					poiLight.rampedLightMap = smoothstep((0.7 /*_LightingAdditiveGradientEnd*/), (0.0 /*_LightingAdditiveGradientStart*/), 1 - (.5 * poiLight.nDotL + .5));
					#if defined(POINT) || defined(SPOT)
					poiLight.finalLighting = lerp(poiLight.directColor * max(min(poiLight.additiveShadow, poiLight.detailShadow), passthrough), poiLight.indirectColor, smoothstep((0.0 /*_LightingAdditiveGradientStart*/), (0.7 /*_LightingAdditiveGradientEnd*/), 1 - (.5 * poiLight.nDotL + .5))) * poiLight.attenuation;
					#else
					poiLight.finalLighting = lerp(poiLight.directColor * max(min(poiLight.attenuation, poiLight.detailShadow), passthrough), poiLight.indirectColor, smoothstep((0.0 /*_LightingAdditiveGradientStart*/), (0.7 /*_LightingAdditiveGradientEnd*/), 1 - (.5 * poiLight.nDotL + .5)));
					#endif
				}
				...
				for (int index = 0; index < 4; index++)
				{
					...
					{
						vertexLighting += lerp(poiLight.vColor[index] * poiLight.vAttenuation[index], poiLight.vColor[index] * (0.5 /*_LightingAdditivePassthrough*/) * poiLight.vAttenuation[index], smoothstep((0.0 /*_LightingAdditiveGradientStart*/), (0.7 /*_LightingAdditiveGradientEnd*/), .5 * poiLight.vDotNL[index] + .5)) * poiLight.detailShadow;
					}
				}
			...
			void applyMatcap(inout PoiFragData poiFragData, in PoiCam poiCam, in PoiMesh poiMesh, inout PoiLight poiLight, in PoiMods poiMods)
			{
				...
				blendMatcap(poiLight, poiFragData, (0.0 /*_MatcapAdd*/), (0.0 /*_MatcapAddToLight*/), _MatcapMultiply, (0.0 /*_MatcapReplace*/), (0.0 /*_MatcapMixed*/), matcap, matcapMask, (0.0 /*_MatcapEmissionStrength*/), (0.0 /*_MatcapLightMask*/)
				#ifdef POI_BLACKLIGHT
			...
			void ApplyRimLighting(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiCam poiCam, in PoiLight poiLight, in PoiMods poiMods)
			{
				...
				float rimWidth = lerp( - .05, 1, (0.804 /*_RimWidth*/));
				float blendStrength = (0.6 /*_RimBlendStrength*/);
				#ifdef POI_AUDIOLINK
				...
				float rim = 1 - smoothstep(min((0.075 /*_RimSharpness*/), rimWidth), rimWidth, viewDotNormal);
			...
			void applyGlitter(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiCam poiCam, in PoiLight poiLight, in PoiMods poiMods)
			{
				...
				half3 glitterColor = poiThemeColor(poiMods, float4(0.7004448,1.131079,1.911214,0), (0.0 /*_GlitterColorThemeIndex*/));
				...
				switch((0.0 /*_GlitterMode*/))
				{
					...
					{
						randomRotation = randomFloat3WiggleRange(randoPoint, (7.2 /*_GlitterAngleRange*/), (0.0 /*_GlitterSpeed*/));
					}
					else
					{
						randomRotation = randomFloat3Range(randoPoint, (7.2 /*_GlitterAngleRange*/));
					}
					float3 glitterReflectionDirection = normalize(mul(poiRotationMatrixFromAngles(randomRotation), norm));
					finalGlitter = lerp(0, (0.0 /*_GlitterMinBrightness*/) * glitterAlpha, glitterAlpha) + max(pow(saturate(dot(lerp(glitterReflectionDirection, poiCam.viewDir, (0.0 /*_GlitterBias*/)), poiCam.viewDir)), (655.0 /*_GlitterContrast*/)), 0);
					...
					finalGlitter = lerp(0, (0.0 /*_GlitterMinBrightness*/) * glitterAlpha, glitterAlpha) + max(pow(specAngle, (655.0 /*_GlitterContrast*/)), 0);
					glitterColor *= poiLight.directColor;
					finalGlitter *= glitterAlpha;
					break;
				}
				glitterColor *= lerp(1, poiFragData.baseColor, (0.679 /*_GlitterUseSurfaceColor*/));
				#if defined(PROP_GLITTERCOLORMAP) || !defined(OPTIMIZER_ENABLED)
				...
				#if defined(PROP_GLITTERMASK) || !defined(OPTIMIZER_ENABLED)
				float glitterMask = POI2D_SAMPLER_PAN(_GlitterMask, _MainTex, poiUV(poiMesh.uv[(0.0 /*_GlitterMaskUV*/)], float4(1,1,0,0)), float4(0,0,0,0));
				#else
				float glitterMask = 1;
				#endif
				...
				{
					poiFragData.baseColor = lerp(poiFragData.baseColor, finalGlitter * glitterColor * (3.4 /*_GlitterBrightness*/), finalGlitter * glitterTexture.a * glitterMask);
					poiFragData.emission += finalGlitter * glitterColor * max(0, ((3.4 /*_GlitterBrightness*/) - 1) * glitterTexture.a) * glitterMask;
				}
				else
				{
					poiFragData.emission += finalGlitter * glitterColor * (3.4 /*_GlitterBrightness*/) * glitterTexture.a * glitterMask;
				}
			}
			#endif
			#ifdef POI_STYLIZED_StylizedSpecular
			void stylizedSpecular(inout PoiFragData poiFragData, in PoiCam poiCam, inout PoiLight poiLight, in PoiMesh poiMesh, in PoiMods poiMods)
			{
				...
				{
					specMask1 += pow(specArea, exp2(lerp(11, 1, (0.437 /*_HighColor_Power*/)))) * (0.582 /*_Layer1Strength*/);
					specMask2 += pow(specArea, exp2(lerp(11, 1, (0.0 /*_Layer2Size*/)))) * (0.0 /*_Layer2Strength*/);
				}
				else
				{
					specMask1 += poiEdgeNonLinear(specArea, (1.0 - pow((0.437 /*_HighColor_Power*/), 5)), (1.0 /*_StylizedSpecularFeather*/)) * (0.582 /*_Layer1Strength*/);
				...
				for (int index = 0; index < 4; index++)
				{
					...
					if ((1.0 /*_Is_SpecularToHighColor*/))
					{
						vSpecMask = pow(specArea, exp2(lerp(11, 1, (0.437 /*_HighColor_Power*/)))) * (0.582 /*_Layer1Strength*/) * poiLight.vAttenuation * poiLight.vColor[index];
					...
					{
						vSpecMask = poiEdgeNonLinear(specArea, (1.0 - pow((0.437 /*_HighColor_Power*/), 5)), (1.0 /*_StylizedSpecularFeather*/)) * (0.582 /*_Layer1Strength*/) * poiLight.vAttenuation * poiLight.vColor[index];
			...
			float4 frag(v2f i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				float3 mainNormal = UnpackScaleNormal(POI2D_SAMPLER_PAN(_BumpMap, _MainTex, poiUV(poiMesh.uv[(7.0 /*_BumpMapUV*/)], float4(1,1,0,0)), float4(0,0,0,0)), _BumpScale);
 ...
 #define OPTIMIZER_ENABLED 
			...
			void applyOutlineColor(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiLight poiLight, in PoiMods poiMods)
			{
				...
				float4 col = POI2D_SAMPLER_PAN(_OutlineTexture, _MainTex, poiUV(poiMesh.uv[(0.0 /*_OutlineTextureUV*/)], float4(1,1,0,0)), float4(0,0,0,0)) * float4(poiThemeColor(poiMods, float4(0.07417662,0.02488853,0.01413793,1).rgb, (0.0 /*_LineColorThemeIndex*/)), float4(0.07417662,0.02488853,0.01413793,1).a);
